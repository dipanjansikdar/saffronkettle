...
ChatGPT conversation history should not be treated as the authoritative copy of the code.
...
The Hero should remain consistent with the black-and-gold premium design.
...
The current approved version should not be changed unless explicitly requested.
...
Show customers some of the food available from Saffron Kettle.
...
The exact menu has **not yet been defined**.

Do not invent a final menu without discussing it first.
...
For the first website version, this does not necessarily need to be a full automated ordering system.
...
- Lovable — rapid AI application development
- Claude / Claude Code — large-codebase development and coding assistance
- Replit — application development and deployment
